        ...
        {isPaused ? (
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="rounded-2xl p-12 text-center">
              <div className="inline-flex items-center justify-center p-3 bg-yellow-50 rounded-xl mb-8">
              ...
              <button
                onClick={() => router.push('/')}
                className="inline-flex items-center px-8 py-3 rounded-xl bg-primary text-white hover:bg-primary-dark transition-colors duration-200"
              >
                Return to Home
              </button>
            </div>
