    ...
    <footer className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#faqs" className="text-gray-500 hover:text-primary transition-colors">FAQs</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a 
                    href="https://um6p.ma/fr/conditions-generales-dutilisation" 
                    target="_blank" 
                ...
                <li><a href="/terms" className="text-gray-500 hover:text-primary transition-colors">Terms of Service</a></li>
                <li>
                  <a 
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.linkedin.com/school/um6p/" 
                target="_blank" 
                rel="noopener noreferrer"
              ...
              <a 
                href="https://www.instagram.com/um6p.officiel/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-primary transition-colors"
              >
        ...
        <div className="pt-8 mt-8 border-t border-gray-200 text-center text-sm text-gray-400">
          &copy; {new Date().getFullYear()} Student Voice. All rights reserved.
        </div>
      </div>
    </footer>
  );
